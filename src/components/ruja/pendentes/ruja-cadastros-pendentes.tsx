...
function Empty() { return <div className="text-center py-16 text-gray-500"><div className="flex justify-center mb-3"><ClipboardList size={36} /></div><p>Nenhum cadastro para estes filtros.</p></div> }
