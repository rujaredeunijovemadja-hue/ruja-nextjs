...
import type { EventoFrequencia, EventoFrequenciaInput, TipoEventoFrequencia } from '@/lib/ruja/types'
              ...
              <div key={evento.id} className="bg-[#111] border border-white/8 rounded-xl p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-gray-500 text-xs mt-1">{evento.data} · {departamentoNomePorId(departamentos, evento.departamento_id)}</p>
      ...
      <div className="bg-[#141414] border border-white/12 rounded-t-2xl md:rounded-2xl w-full max-w-3xl max-h-[92dvh] flex flex-col">
        ...
        <div className="overflow-y-auto p-5 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <input value={observacao} onChange={e => setObservacao(e.target.value)} placeholder="Observação" className={INP} />
          </div>
