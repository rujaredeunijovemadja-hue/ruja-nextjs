...
const RujaPodSimply = dynamic(() => import('../plataformas/ruja-podsimply'))
const RujaHappyHour = dynamic(() => import('../plataformas/ruja-happy-hour'))
const RujaEbd = dynamic(() => import('../plataformas/ruja-ebd'))
const RujaMissoes = dynamic(() => import('../missoes/ruja-missoes'))
const RujaAutomacao = dynamic(() => import('../automacao/ruja-automacao'))
...
export function RujaLayout({ profile, platforms }: Props) {
  ...
  for (const platform of platforms) {
    ...
    PAGES[platform.slug as RujaPage] = platform.slug === 'central-ebd'
      ...
      : platform.slug === 'contabilidade' ? <RujaContabilidade access={platform} /> : platform.slug === 'redacao' ? <RujaRedacao access={platform} /> : platform.slug === 'palestras' ? <RujaPalestras access={platform} /> : platform.slug === 'altar' ? <RujaAltar access={platform} /> : platform.slug === 'podsimply' ? <RujaPodSimply access={platform} /> : platform.slug === 'happy-hour' ? <RujaHappyHour access={platform} /> : <RujaPlataformaWorkspace access={platform} />
  }
