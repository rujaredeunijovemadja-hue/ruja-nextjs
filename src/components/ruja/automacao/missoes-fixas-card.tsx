...
export default function MissoesFixasCard() {
  ...
  const [form, setForm] = useState({ titulo: '', descricao: '', alvo_tipo: 'lider' as 'jovem' | 'lider' | 'usuario', alvo_nome: '', plataforma_id: '', prioridade: 'normal' as MissaoFixa['prioridade'], recorrencia: 'semanal' as Recorrencia, dia_semana: 6, dia_mes: 1, prazo_dias: 2 })
